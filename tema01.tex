...
% El argumento opcional de marginfigure es un desplazamiento vertical: aquí
% deja aire por arriba. El \vspace* final lo deja por abajo, y además cuenta
% para la altura de la caja, de modo que LaTeX reserva ese hueco y ninguna
% nota al margen se pega al retrato.
