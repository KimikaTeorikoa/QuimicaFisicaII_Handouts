...
se desplaza hacia longitudes de onda más cortas. Esta observación la
...
excitado. A partir de una descripción que suponía que la temperatura
...
\label{eq:planck}
\end{equation}
Para longitudes de onda cortas, $\rho$ se hace cero debido al 
...
\begin{enumerate}
    ...
    angular
    y suponía que las órbitas permitidas debían satisfacer la relación
    $L=m_evr=n\hbar$.
\end{enumerate}
