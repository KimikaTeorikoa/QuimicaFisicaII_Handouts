...
de la radiación del denominado ``cuerpo negro'' (Figura \ref{fig:wien}).%
\begin{marginfigure}
...
ultravioleta'', porque de acuerdo con el aumento monótono de
la densidad espectral de energía, la cantidad de radiación de alta energía 
...
En la aproximación de Rayleigh y Jeans se asumía que las energías 
de los osciladores podían tomar cualquier valor, y eran por tanto
...
exponer a un material determinado a una radiación
...
pueden ser observadas (Figura \ref{fig:debroglie}).
...
\begin{figure}
  ...
  sólo se observa difracción cuando $\lambda_\mathrm{dB}$ es comparable al
...
1927.\sidenote{Este descubrimiento le valió un Premio Nobel en 1932 por ``la creación de la Mecánica Cuántica''.} 
...
el de \textbf{Niels Bohr}, que partía de dos suposiciones:\sidenote{Bohr recibió el Premio Nobel en 1922 por
su trabajo su ``investigación de la estructura de los átomos y
la radiación que emana de ellos''} 
\begin{enumerate}
...
\begin{figure*}
  ...
  correspondientes, en escala logarítmica de $\lambda$. Sólo la serie de
